This website contains a curated list of 3rd party projects that use [MachineWare's](https://www.machineware.de/) [VCML (Virtual Components Modeling Library)](https://github.com/machineware-gmbh/vcml).
